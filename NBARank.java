...
public class NBARank {
    ...
    public static void main(String[] args) throws IOException{
        URL url = new URL("http://data.nba.net/10s/prod/v1/2019/players.json"); // getting each player's NBA key
        ...
        for (int i = 0; i < keys.size(); i++) {
            URL url2 = new URL("http://data.nba.net/10s/prod/v1/2019/players/" + keys.get(i) +"_profile.json"); // accessing each players stats
